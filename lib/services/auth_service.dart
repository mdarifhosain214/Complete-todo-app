    ...
    try{
      ...
      if(googleSignInAccount!=null){
        ...
        try{
          ...
          final snackBar = SnackBar(content: Text(e.toString(),style: const TextStyle(fontSize: 17),));
        ...
        const snackBar = SnackBar(content: Text("Unable to create an account",style: TextStyle(fontSize: 17),));
        ScaffoldMessenger.of(context).showSnackBar(snackBar);
